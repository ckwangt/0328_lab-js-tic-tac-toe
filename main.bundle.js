...
var Cell = function (_Component) {
    ...
    _createClass(Cell, [{
        key: 'writeCell',
        value: function writeCell(input) {
            this.root.textContent = input;
            this.cellOccupy = true;
        }
    }, {
        key: 'handleDomClick',
        value: function handleDomClick(e) {
            if (this.cellOccupy === false) {
                this.fire('cellClick', this.cellNumber);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__banner_css__ = __webpack_require__(88);
...
var Role = function (_Component) {
    ...
    _createClass(Role, [{
        ...
        value: function addRole() {
            this.roleValue++;
            this.root.textContent = this.roleValue;
        }
    }, {
        key: 'reset',
        value: function reset() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__banner_js__ = __webpack_require__(122);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cell_js__ = __webpack_require__(90);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__grid_js__ = __webpack_require__(123);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__reset_js__ = __webpack_require__(124);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__role_js__ = __webpack_require__(91);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__main_css__ = __webpack_require__(320);
...
var Main = function (_Component) {
    ...
    function Main(root) {
        ...
        _this.grid = new __WEBPACK_IMPORTED_MODULE_3__grid_js__["a" /* default */](root.querySelector('.grid'));
        _this.grid.on('goodClick', _this.handleGoodClick.bind(_this));
        _this.grid.on('gameOver', _this.handleGameOver.bind(_this));
    ...
    _createClass(Main, [{
        key: 'handleGoodClick',
        value: function handleGoodClick() {
            this.changeTurn();
        }
    }, {
        key: 'handleGameOver',
        value: function handleGameOver(firer, finalPlayer) {
            this.addWinner(finalPlayer);
        }
    }, {
        key: 'addWinner',
        value: function addWinner(finalPlayer) {
            if (finalPlayer === 'X') this.banner.roles[0].addRole();else if (finalPlayer === 'O') this.banner.roles[1].addRole();
        }
    }, {
        key: 'changeTurn',
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__role_js__ = __webpack_require__(91);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__turn_js__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__banner_css__ = __webpack_require__(88);
...
var Banner = function (_Component) {
    ...
    function Banner(root) {
        ...
        _this.roles = [];
        var els = root.querySelectorAll('.role');
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cell_js__ = __webpack_require__(90);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__banner_css__ = __webpack_require__(88);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__banner_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__banner_css__);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
    ...
    function Grid(root) {
        ...
        try {
            for (var _iterator = els[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                ...
                cell.on('cellClick', _this.handleCellClick.bind(_this));
        ...
        for (var i = 0; i < 9; i++) {
            _this.cells[i].cellNumber = i;
            _this.cellStatus[i] = false; //false = unoccupied
        }
    ...
    _createClass(Grid, [{
        ...
        value: function handleCellClick(firer, cellNumber) {
            if (this.gameOver === false) {
                // this.cells[cellNumber].root.textContent = 'R';
                this.cells[cellNumber].writeCell(this.turnValue);
                this.cellStatus[cellNumber] = this.turnValue;
                // console.log('cellStatus'+this.cellStatus[cellNumber]);
                // console.log(this.checkGameOver());
                if (this.checkGameOver() === false) {
                    this.fire('goodClick');
                } else this.fire('gameOver', this.turnValue);
            }
        }
    }, {
        key: 'changeTurn',
        value: function changeTurn() {
            if (this.turnValue === 'X') this.turnValue = 'O';else this.turnValue = 'X';
        }
    }, {
        key: 'checkGameOver',
        value: function checkGameOver() {
            if (this.checkRow(0, 1, 2) || this.checkRow(3, 4, 5) || this.checkRow(6, 7, 8) || this.checkRow(0, 3, 6) || this.checkRow(1, 4, 7) || this.checkRow(2, 5, 8) || this.checkRow(0, 4, 8) || this.checkRow(2, 4, 6)) {
                this.gameOver = true;
                return true;
            } else return false;
        }
        ...
        key: 'checkRow',
        value: function checkRow(a, b, c) {
            if (this.cellStatus[a] === this.cellStatus[b] && this.cellStatus[a] === this.cellStatus[c] && this.cellStatus[a] != '') {
                return true;
            } else return false;
        }
        ...
        //
        // if (this.turnValue === 'x') {
        //     this.cell.cellDisplay.textContent = 'x'
        //     this.fire('cellClick');
        // } else {
        //   this.cell.cellDisplay.textContent = 'o'
        //   this.fire('cellClick');
        // }
        // if(turnValue === 'x') {
        //   this.cell.cellDisplay.textContent = 'x';
        //   turnValue = 'o';
        // }
        // else this.cell.cellDisplay.textContent = 'o';{
        //   turnValue = 'x';
        // }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__turn_css__ = __webpack_require__(322);
...
var Turn = function (_Component) {
    ...
    _createClass(Turn, [{
        ...
        value: function changeTurn() {
            if (this.turnValue === 'X') {
                this.turnValue = 'O';
                this.root.textContent = this.turnValue;
            } else {
                this.turnValue = 'X';
                this.root.textContent = this.turnValue;
            }
...
// module
exports.push([module.i, ".banner{\r\n  text-align: center;\r\n  background-color: rgb(104, 194, 132);\r\n  display: block;\r\n  width: 100%;\r\n  border-radius: 0.5rem;\r\n}\r\n", ""]);
...
// module
exports.push([module.i, ".reset{\r\n /*border: 0.1rem solid;*/\r\n  background-color: rgb(67, 144, 215);\r\n\r\n  width: 100%;\r\n  padding: 0.5rem;\r\n  text-align: center;\r\n\r\n  border-radius: 1rem;\r\n  display: block;\r\n  /*width: 50%;*/\r\n  border-radius: 0.5rem;\r\n    cursor: pointer;\r\n}\r\n", ""]);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(89), __webpack_require__(316)))
